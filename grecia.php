...
<head>
  ...
  <title>VoyageExpress | Grécia</title>
...
<body>
  ...
  <section class="container">
    <div class="text-center my-5">
      ...
      <h1 class="display-4 text-primary">Descubra Grécia</h1>
    </div>
    <div class="row">
      <div class="col-md">
        <img src="img/Grecia/img1.jpg" class="img-fluid mb-4">
        <img src="img/Grecia/img2.jpg" class="img-fluid mb-4">
        <img src="img/Grecia/img3.jpg" class="img-fluid mb-4">
      </div>
      <div class="col-md">
        <img src="img/Grecia/img4.jpg" class="img-fluid mb-4">
        <img src="img/Grecia/img5.jpg" class="img-fluid mb-4">
      </div>
      <div class="col-md">
        <img src="img/Grecia/img6.jpg" class="img-fluid mb-4">
        <img src="img/Grecia/img7.jpg" class="img-fluid mb-4">
    ...
    <table class="table table-hover table-responsive-md">
      ...
      <tbody>
        <tr>
          ...
          <td>Olympiacos F.C.</td>
          <td>Georgios Karaiskakis Stadium</td>
          <td><a href="https://www.viagogo.com/Sports-Tickets/Soccer/Greek-Super-League/Olympiacos-FC-Tickets/E-151599734" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
        <tr>
          <th scope="row">05/04</th>
          <td>Slava’s Snowshow</td>
          <td>Pallas Theatre</td>
          <td><a href="https://www.viagogo.com/Theater-Tickets/Family/Slavas-Snowshow-Tickets/E-151605965" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
        <tr>
          <th scope="row">21/04</th>
          <td>Arcturus</td>
          <td>Fuzz Club</td>
          <td><a href="https://www.viagogo.com/Concert-Tickets/Hard-Rock-Metal/Arcturus-Tickets/E-151623056" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
        <tr>
          <th scope="row">21/04</th>
          <td>Black Coffee</td>
          <td>Faliro Sports Pavilion Arena</td>
          <td><a href="https://www.viagogo.com/Concert-Tickets/Clubs-and-Dance/Black-Coffee-Tickets/E-151426237" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
      </tbody>
    </table>
  </section>
  ...
  <div class="text-center my-5">
    ...
    <h1 class="display-4 text-primary">Tour Grécia</h1>
  </div>
  
      <video class="video" controls>
        <source src="img/Videos/grecia.webm" type="video/mp4">
        <source src="img/Videos/grecia.webm" type="video/webm">
