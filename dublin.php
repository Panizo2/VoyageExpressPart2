...
<head>
  ...
  <title>VoyageExpress | Dublin</title>
...
<body>
  ...
  <section class="container">
    ...
    <div class="row">
      <div class="col-md">
        <img src="img/local/foto-1.jpg" class="img-fluid mb-4">
        <img src="img/local/foto-2.jpg" class="img-fluid mb-4">
        <img src="img/local/foto-3.jpg" class="img-fluid mb-4">
      </div>
      <div class="col-md">
        <img src="img/local/foto-4.jpg" class="img-fluid mb-4">
        <img src="img/local/foto-5.jpg" class="img-fluid mb-4">
      </div>
      <div class="col-md">
        <img src="img/local/foto-6.jpg" class="img-fluid mb-4">
        <img src="img/local/foto-7.jpg" class="img-fluid mb-4">
      </div>
    </div>
  </section>
    ...
    <table class="table table-hover table-responsive-md">
      ...
      <tbody>
        <tr>
          ...
          <td>The Academy</td>
          <td><a href="https://www.ticketmaster.ie/search?q=Rainbow+Kitten+Surprise+the+academy&clickId=QDoylXQzMxyNW5u1Nqw-B0e0UkATzNwLRwmmwM0&irgwc=1&utm_source=219208-Bandsintown&utm_medium=affiliate&utm_campaign=219208&ircid=7512&camefrom=CFC_BUYAT_219208#_=_" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
        <tr>
          <th scope="row">07/04</th>
          <td>Mimi Webb</td>
          <td>3Olympia Theatre</td>
          <td><a href="https://tix.to/MimiRM#_=_" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
        <tr>
          <th scope="row">09/04</th>
          <td>Hozier</td>
          <td>The Academy</td>
          <td><a href="https://www.viagogo.com/Concert-Tickets/Jazz-and-Blues/Hozier-Tickets/E-151568160?PCID=partnerize_all&utm_campaign=1101l5856&utm_medium=publisher_program&utm_source=partnerize_jambase&utm_sub_medium=Content" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
        <tr>
          <th scope="row">09/04</th>
          <td>Sonny Fodera</td>
          <td>3Arena</td>
          <td><a href="https://www.ticketmaster.ie/sonny-fodera-dublin-09-04-2023/event/18005D8588A7B1FF" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
      </tbody>
    </table>
  </section>
  <div class="text-center my-5">
    ...
    <h1 class="display-4 text-primary">Tour Dublin</h1>
  </div>
  
      <video class="video" controls>
        <source src="img/Videos/dublin.webm" type="video/mp4">
        <source src="img/Videos/dublin.webm" type="video/webm">
