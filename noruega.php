...
<body>
  ...
  <section class="container">
    <div class="text-center my-5">
      ...
      <h1 class="display-4 text-primary">Descubra Noruega</h1>
    </div>
    <div class="row">
      <div class="col-md">
        <img src="img/Noruega/img1.jpg" class="img-fluid mb-4">
        <img src="img/Noruega/img2.jpg" class="img-fluid mb-4">
        <img src="img/Noruega/img3.jpg" class="img-fluid mb-4">
      </div>
      <div class="col-md">
        <img src="img/Noruega/img4.jpg" class="img-fluid mb-4">
        <img src="img/Noruega/img5.jpg" class="img-fluid mb-4">
      </div>
      <div class="col-md">
        <img src="img/Noruega/img6.jpg" class="img-fluid mb-4">
        <img src="img/Noruega/img7.jpg" class="img-fluid mb-4">
      </div>
    </div>
  </section>
  ...
  <section class="container">
    ...
    <table class="table table-hover table-responsive-md">
      ...
      <tbody>
        <tr>
          <th scope="row">06-09/04</th>
          <td>Inferno Metal Festival 2023</td>
          <td>Rockefeller</td>
          <td><a href="https://www.viagogo.com/Festival-Tickets/Festivals-in-Norway/Inferno-Metal-Festival-Tickets/E-151263423" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
        <tr>
          <th scope="row">14/04</th>
          <td>Jordbærstedet</td>
          <td>Kanonhallen</td>
          <td><a href="https://www.viagogo.com/Theater-Tickets/Theater/Jordbaerstedet-Tickets/E-151604894" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
        <tr>
          <th scope="row">15/04</th>
          <td>Star Wars:The Empire Strikes Back Live In Concert</td>
          <td>Oslo Spektrum</td>
          <td><a href="https://www.viagogo.com/Theater-Tickets/Classical/Star-Wars-In-Concert-Tickets/E-151350459" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
        <tr>
          <th scope="row">21/04</th>
          <td>Joe Bonamassa</td>
          <td>Oslo Spektrum</td>
          <td><a href="https://www.viagogo.com/Concert-Tickets/Jazz-and-Blues/Joe-Bonamassa-Tickets/E-150556182" class="btn btn-outline-secondary btn-sm">Comprar Ingresso</a></td>
        </tr>
      </tbody>
    </table>
  </section>
  <div class="text-center my-5">
    ...
    <h1 class="display-4 text-primary">Tour Noruega</h1>
  </div>
  
      <video class="video" controls>
        <source src="img/Videos/noruega.webm" type="video/mp4">
        <source src="img/Videos/noruega.webm" type="video/webm">
